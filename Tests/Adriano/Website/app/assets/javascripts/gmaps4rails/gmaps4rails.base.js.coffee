...
class @Gmaps4Rails
  ...
  constructor: ->
    ...
    @default_map_options =
      ...
      center_latitude: gon.latitude
      center_longitude: gon.longitude
      zoom: 14
      maxZoom: null
      minZoom: 3
    ...
    @default_markers_conf =
      ...
      max_random_distance: 1 # in meters. Each marker coordinate could be altered by this distance in a random direction
